...
<php lang="en">
    ...
    <!-- molla/index-13.php  22 Nov 2019 09:59:06 GMT -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4 ">
                                <a href="category.php" class="cat-block">
                                    <figure>
                                        <span>
                                            <img src="assets/images/products/kosmetik/kosmetik.png"
                                                alt="Category image">
                                        </span>
                                    </figure>
                ...
                <div class="tab-content tab-content-carousel">
                    <div class="tab-pane p-0 fade show active" id="hot-all-tab" role="tabpanel"
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                            ...
                            <?php
$ambil = $conn->query("SELECT b.kode, b.barang, sp.supplier, b.generik, b.foto, s.satuan, k.kategori, g.golongan, be.bentuk, b.beli, b.jual, b.minimum, b.maximum, b.created, b.update
FROM barang b 
...
ORDER BY kode;");
while ( $product = $ambil->fetch_object()) {
//if (!empty($product)) { 
//	foreach($product as $key=>$value){ ?>
                            <div class="product">
                                <form method="post" action="index.php?action=add&code<?php echo $product->kode ?> ">
                                    <figure class="product-media">
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.php">
                                            <img src="assets/images/products/obat/<?php echo $product->foto ?>"
                                        ...
                                        <div class="product-action">
                                            <a href="cart.php?kode= <?php echo $product->kode; ?> &action=add"
                                    ...
                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#"><?php echo $product->kategori ?>
                                                <?php echo $product->golongan ?></a>
                                        </div><!-- End .product-cat -->
                                        <h3 class="product-title"><?php echo $product->barang ?><a
                                                href="product.php"></a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">Rp.<?php echo $product->jual ?>.000</span>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.php">
                                        <img src="assets/images/products/alatkesehatan/airpurifier.jpg"
                                            alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.php">
                                        <img src="assets/images/products/alatkesehatan/humidifier.png"
                                            alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <a href="product.php">
                                        <img src="assets/images/products/alatkesehatan/termometer.png"
                                            alt="Product image" class="product-image">
                                    </a>
        ...
        <div class="container obat">
            <div class="heading heading-flex heading-border mb-3">
                ...
                <div class="heading-right">
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="obat-new-link" data-toggle="tab" href="#obat-new-tab"
                                role="tab" aria-controls="obat-new-tab" aria-selected="true">New</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="tab-content tab-content-carousel">
                ...
                <div class="tab-pane p-0 fade" id="obat-featured-tab" role="tabpanel"
                    aria-labelledby="obat-featured-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false, 
                                "dots": true,
        ...
        <div class="container kosmetik">
            <div class="heading heading-flex heading-border mb-3">
                ...
                <div class="heading-right">
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="kosmetik-featured-link" data-toggle="tab"
                                href="#kosmetik-featured-tab" role="tab" aria-controls="kosmetik-featured-tab"
            ...
            <div class="tab-content tab-content-carousel">
                ...
                <div class="tab-pane p-0 fade" id="kosmetik-best-tab" role="tabpanel"
                    aria-labelledby="kosmetik-best-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false, 
                                "dots": true,
        ...
        <div class="container alat ">
            <div class="heading heading-flex heading-border mb-3">
                ...
                <div class="heading-right">
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="alat-new-link" data-toggle="tab" href="#alat-new-tab"
                                role="tab" aria-controls="alat-new-tab" aria-selected="true">New</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="tab-content tab-content-carousel">
                ...
                <div class="tab-pane p-0 fade" id="alat-featured-tab" role="tabpanel"
                    aria-labelledby="alat-featured-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false, 
                                "dots": true,
    ...
    <!-- molla/index-13.php  22 Nov 2019 09:59:31 GMT -->
