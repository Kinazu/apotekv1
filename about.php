                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    ...
                                    <p>Praesent dapibus, neque id cursus faucibus, <br>tortor neque egestas augue,
                                        eu
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    ...
                                    <p>Pellentesque a diam sit amet mi ullamcorper <br>vehicula. Nullam quis massa
                                        sit
                ...
                <div class="bg-light-2 pt-6 pb-7 mb-6">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    ...
                                    <div class="member-content">
                                        <h3 class="member-title">Damion Blue<span>Sales & Marketing Manager</span>
                                        </h3>
                                        <!-- End .member-title -->
                                    </div><!-- End .member-content -->
                                </div><!-- End .member -->
                        ...
                        <div class="text-center mt-3">
                            <a href="blog.php" class="btn btn-sm btn-minwidth-lg btn-outline-primary-2">
