            ...
            <div class="row">
                <div class="col-sm-12 col-lg-6">
                    <div class="widget widget-about">
                        <img src="assets/dist/img/logo.png" class="footer-logo" alt="Footer Logo" width="105"
                            height="25">
                        ...
                        <div class="widget-about-info">
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <a href="tel:123456789">+62 85774623342</a>
                                </div><!-- End .col-sm-6 -->
                ...
                <div class="col-sm-4 col-lg-2">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="about.php">About Apotek</a></li>
                            <li><a href="#">How to shop on Apotek</a></li>
