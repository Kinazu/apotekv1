...
/*if(isset($_SESSION['apoteker'])) {
    ...
    header('Location: page/karyawan/beranda.php');
}elseif(isset($_SESSION['supplier'])) {
    header('Location: page/supplier/beranda.php');
}else {
    echo "<script>
...
<body class="hold-transition dark-mode layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg px-0 py-2 d-flex flex-row justify-content-between"
            ...
            <div class="container-fluid">
                ...
                <form class="d-flex" role="search">
                    <input type="search" id="search_box" placeholder="Ketik keluhan / obat yang anda cari" value
                        onkeyup="runScript(event);" autocomplete="off" class="ui-autocomplete-input">holder="Ketik Obat
